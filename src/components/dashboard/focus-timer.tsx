...
import { ENERGY_CONFIGS, ENERGY_TYPES, AURA_DEFS, AURA_RARITY_COLORS, AURA_RARITY_LABELS, getEnergyReward, type EnergyType, type EnergyStage } from "@/lib/energy-assets";
        ...
        <div className="grid grid-cols-3 gap-3">
          {ENERGY_TYPES.map((type) => {
            ...
            return (
              <button
                key={type}
                onClick={() => { if (isOwned) { onSelect(type); onClose(); } }}
                disabled={!isOwned}
