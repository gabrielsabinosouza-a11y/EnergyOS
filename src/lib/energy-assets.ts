...
export const ENERGY_CONFIGS: Record<EnergyType, EnergyConfig> = {
  ...
  ice:     { ...AURA_DEFS.ice,     locked: true,  accent: ENERGY_THEME_COLORS.ice,     glow: glowOf("ice"),     assets: { spark: "/energies/ice/ice_begin.png",    forming: "/energies/ice/ice_mid.png",    full: "/energies/ice/ice_full.png",    extinguished: "/energies/ice/ice_gave_upo.png"    } },
  wind:    { ...AURA_DEFS.wind,    locked: true,  accent: ENERGY_THEME_COLORS.wind,    glow: glowOf("wind"),    assets: { spark: "/energies/wind/wind_begin.png",    forming: "/energies/water/water_mid.png",    full: "/energies/water/water_full.png",    extinguished: "/energies/water/water_give_up.png"    } },
